...
namespace ClinicService.Services.Impl
{
    public class ConsultationRepository : IConsultationRepository
    {
        ...
        public int Create(Consultation item)
        {
            ...
            command.CommandText = "INSERT INTO Consultations(ConsultationId, ClientId, PetId, ConsultationDate, Description) VALUES(@ConsultationId, @ClientId, @PetId, @ConsultationDate, @Description)";
