...
namespace ClinicService.Services.Impl
{
    public class PetRepository : IPetRepository
    {
        ...
        public int Create(Pet item)
        {
            ...
            command.Parameters.AddWithValue("@Document", item.PetId);
            command.Parameters.AddWithValue("@SurName", item.ClientId);
            command.Parameters.AddWithValue("@FirstName", item.Name);
        ...
        public int Update(Pet item)
        {
            ...
            connection.Open();
            SQLiteCommand command = new SQLiteCommand(connection);
            command.CommandText = "UPDATE pets SET PetId = @PetId, ClientId = @ClientId, Name = @Name, Birthday = @Birthday WHERE ClientId = @ClientId";
